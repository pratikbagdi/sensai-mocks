...
function RecordAnswerSection({mockInterviewQuestion,activeQuestionIndex,interviewData}) {
  ...
  return (
    <div className='flex items-center justify-center flex-col bg-black text-white'>
        <div className='flex flex-col mt-20 justify-center items-center bg-gray-900 rounded-lg p-5 shadow-lg border border-gray-700'>
        ...
        <Button 
        disabled={loading}
        variant="outline" className="my-10 bg-gray-800 hover:bg-gray-700 text-white border border-gray-600 flex items-center gap-2 px-5 py-2 rounded-lg"
